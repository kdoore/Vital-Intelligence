...
* **Collective Intelligence (CI)** — which includes both:
  * _collective human sense-making_, and
  * _computational intelligence operating at scale_
...
They are not treated as roles, identities, or prescriptions.\
Speculative and non-human lenses are often used to reduce identification and support safe exploration.
...
If these models cease to be useful, they should be revised or replaced.\
That process itself is an expression of intelligence.
