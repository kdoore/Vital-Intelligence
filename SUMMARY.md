...
* [Process & Authorship Bridging Spiral](vim-bridging-spiral/process-and-authorship-bridging-spiral/README.md)
  ...
  * [The Garment](vim-bridging-spiral/process-and-authorship-bridging-spiral/the-garment.md)
  * [The Instruments](vim-bridging-spiral/process-and-authorship-bridging-spiral/the-instruments.md)
  * [The Habitat](vim-bridging-spiral/process-and-authorship-bridging-spiral/the-habitat.md)
  ...
  * [Living Systems in Motion: Two Simulations](vim-bridging-spiral/process-and-authorship-bridging-spiral/living-systems-in-motion-two-simulations.md)
  * [TKGPT System Prompt - v0.3](vim-bridging-spiral/process-and-authorship-bridging-spiral/tkgpt-system-prompt-v0.3.md)
...
* [Transformative Kindness GPT (TKGPT)](vim-introduction/transformative-kindness-gpt-tkgpt/README.md)
  ...
  * [Transformative AI – Kindness Performance Indicators](vim-introduction/transformative-kindness-gpt-tkgpt/transformative-ai-kindness-performance-indicators.md)
  * [Integrity, Resonance, and Systemic Capture](vim-introduction/transformative-kindness-gpt-tkgpt/integrity-resonance-and-systemic-capture.md)
  * [How to Cite and Reuse This Work](vim-introduction/transformative-kindness-gpt-tkgpt/how-to-cite-and-reuse-this-work.md)
  * [How to Collaborate With This Work](vim-introduction/transformative-kindness-gpt-tkgpt/how-to-collaborate-with-this-work.md)
  * [Declaration of Intentional Authorship](vim-introduction/transformative-kindness-gpt-tkgpt/declaration-of-intentional-authorship.md)
* [VIM White Paper](vim-introduction/vim-white-paper.md)
* [Why Mental Models Matter in Education](vim-introduction/why-mental-models-matter-in-education.md)
* [Universities as Civic Knowledge Organisms](vim-introduction/universities-as-civic-knowledge-organisms.md)
* [From Legacy Control Models to Vital Intelligence](vim-introduction/from-legacy-control-models-to-vital-intelligence.md)
* [When Mental Models Fail — and Why Meta-Models Matter](vim-introduction/when-mental-models-fail-and-why-meta-models-matter.md)
* [Two Paradigms: Control-Flow vs Modeling & Simulation](vim-introduction/two-paradigms-control-flow-vs-modeling-and-simulation.md)
* [Meta-Model Comparisons](vim-introduction/meta-model-comparisons.md)
* [From Flatland to Holarchy](vim-introduction/from-flatland-to-holarchy.md)
* [What Is Vital Intelligence Model(VIM)?](vim-introduction/what-is-vital-intelligence-model-vim.md)
* [Learning as Model Revision](vim-introduction/learning-as-model-revision.md)
* [Kindness as an Attractor in Learning Systems](vim-introduction/kindness-as-an-attractor-in-learning-systems.md)
* [Dark Attractors, Collective Intelligence, and Institutional Integrity](vim-introduction/dark-attractors-collective-intelligence-and-institutional-integrity.md)
* [The Art of Kindness (AoK) as a Proven, Interdisciplinary Learning Model](vim-introduction/the-art-of-kindness-aok-as-a-proven-interdisciplinary-learning-model.md)
* [(STEM & Arts)++ Interlude:](vim-introduction/stem-and-arts-++-interlude.md)
* [AoK Updated for a Generative AI Era](vim-introduction/aok-updated-for-a-generative-ai-era.md)
* [AoK as a Scalable Educational Pattern](vim-introduction/aok-as-a-scalable-educational-pattern.md)
* [Education as the Primary Leverage Point](vim-introduction/education-as-the-primary-leverage-point.md)
* [Established Learning Frameworks and Their Domains](vim-introduction/established-learning-frameworks-and-their-domains.md)
* [Implications for AI Task Forces](vim-introduction/implications-for-ai-task-forces.md)
* [Defence-in-Depth for Human Meaning-Making](vim-introduction/defence-in-depth-for-human-meaning-making.md)
* [Playing the Infinite Game](vim-introduction/playing-the-infinite-game.md)
* [VIM Expanded Glossary](vim-introduction/vim-expanded-glossary.md)
* [VIM Overview](vim-introduction/vim-overview/README.md)
  * [Vital Intelligence Model:](vim-introduction/vim-overview/readme/README.md)
    * [Theoretical Frameworks](vim-introduction/vim-overview/readme/theoretical-frameworks/README.md)
      * [Evolutionary Transformations](vim-introduction/vim-overview/readme/theoretical-frameworks/evolutionary-transformations.md)
      * [Complexity and Evoloutionary Frameworks](vim-introduction/vim-overview/readme/theoretical-frameworks/complexity-and-evoloutionary-frameworks.md)
    * [Avalanche of Kindness](vim-introduction/vim-overview/readme/avalanche-of-kindness/README.md)
      * [Humanity++: Visions for Evolutionary Transformations](vim-introduction/vim-overview/readme/avalanche-of-kindness/humanity++-visions-for-evolutionary-transformations.md)
    * [Trauma-Informed Holarchy](vim-introduction/vim-overview/readme/trauma-informed-holarchy.md)
...
* [Doughnut Economics Action Lab: September 2025](presentations/doughnut-economics-action-lab-september-2025/README.md)
  ...
  * [Attention: Resisting AI Harms, Reclaiming Human Wisdom](presentations/doughnut-economics-action-lab-september-2025/attention-resisting-ai-harms-reclaiming-human-wisdom.md)
  * [Change the Goal: From GDP, Accelerationism -> Planetary Wellbeing](presentations/doughnut-economics-action-lab-september-2025/change-the-goal-from-gdp-accelerationism-greater-than-planetary-wellbeing.md)
  * [See The Big Picture: Interdependent Ecosystems](presentations/doughnut-economics-action-lab-september-2025/see-the-big-picture-interdependent-ecosystems.md)
  * [Nurture Nature: Healing Torus- Being, Belonging, Becoming](presentations/doughnut-economics-action-lab-september-2025/nurture-nature-healing-torus-being-belonging-becoming.md)
  * [Getting Savy With Systems: Feeling Coherence](presentations/doughnut-economics-action-lab-september-2025/getting-savy-with-systems-feeling-coherence.md)
  * [Design to Distribute: Centralization to Commons](presentations/doughnut-economics-action-lab-september-2025/design-to-distribute-centralization-to-commons.md)
  * [Create to Regenerate](presentations/doughnut-economics-action-lab-september-2025/create-to-regenerate.md)
  * [Beyond the Race to AGI / ASI / GDP](presentations/doughnut-economics-action-lab-september-2025/beyond-the-race-to-agi-asi-gdp.md)
  * [Open Questions](presentations/doughnut-economics-action-lab-september-2025/open-questions.md)
...
* [Colors & Symbols](design-system/colors-and-symbols.md)
* [Imagery & Guidelines](design-system/imagery-and-guidelines.md)
...
* [VI Diagrams](assets/vi-diagrams.md)
